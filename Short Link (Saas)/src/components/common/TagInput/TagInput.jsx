...
export function TagInput({ tags, setTags }) {
    ...
    return (
        <div className="flex flex-col gap-1">
            <label className="text-[14px] sm:text-[16px] flex items-center justify-center gap-2 font-[Inter]" htmlFor="tags">
            ...
            <div
                ...
                className="w-[90%] sm:w-[80%] cursor-alias m-auto relative flex items-center gap-2 px-3 py-2 min-h-[40px] sm:min-h-[48px] bg-zinc-900 border border-zinc-800 text-[12px] sm:text-sm"
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {tags.map((tag, index) => (
                        ...
                        >
                            <span className="transition-opacity text-[12px] sm:text-[16px] cursor-pointer duration-200 group-hover:opacity-0">
                                {tag.tag}
                            </span>
                                ...
                                </Input>
                                {
                                    tagError && (
                                        <motion.p
                                            ...
                                            className="mt-1 text-xs text-red-400 font-[Inter]"
                                        >
                                            {tagError}
                                        </motion.p>
                                    )
