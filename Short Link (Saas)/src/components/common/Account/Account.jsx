    ...
    return (
        ...
        >
            ...
            {showUserInfo && (
                <div
                    id="userInfo"
                    className="absolute right-0 top-12 z-[500] w-62 xs:w-72 rounded-xl border border-zinc-800 bg-zinc-950 p-5 shadow-2xl backdrop-blur-md"
                >
                    <div className="space-y-1 border-b border-zinc-800 pb-4">
                        <p className="text-[12px] xs:text-sm text-zinc-400">Signed in as</p>
                        <h3 className="flex relative items-center gap-1.5 text-base font-semibold text-white">
                            <span className="text-[14px] xs:text-[16px]">
                                {userInfo?.name}
                            </span>

                            <span className="text-[12px] xs:text-[14px] p-0 m-0">
                        ...
                        <p className="truncate text-[12px] xs:text-sm text-zinc-500">
                            {userInfo?.email}
                        </p>
                    </div>

                    {error && (
                        <p className="mt-4 rounded-md bg-red-500/10 px-3 py-2 text-[12px] xs:text-sm text-red-400">
                            {error}
                        </p>
                    )}
